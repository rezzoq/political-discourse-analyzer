...
TARGET_DATE_FROM = "2026-01-26 00:00"
...
FROM statements
WHERE created_at >= '{TARGET_DATE_FROM}'
...
# 4. Сохраняем в CSV
# =========================
clean_df.to_csv("scholz_quotes_new.csv", index=False, encoding="utf-8")
print("💾 Сохранено в scholz_quotes_new.csv")
